...
def View_Prediction_Of_Product_Review_Trust_Ratio(request):
    ...
    return render(request, 'SProvider/View_Prediction_Of_Product_Review_Trust_Ratio.html', {'objs': obj})
...
def View_Prediction_Of_Product_Review_Trust(request):
    ...
    return render(request, 'SProvider/View_Prediction_Of_Product_Review_Trust.html', {'list_objects': obj})
