"""trustworthiness_assessment URL Configuration
...
from trustworthiness_assessment import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Product_Review_Trust/$', remoteuser.Predict_Product_Review_Trust, name="Predict_Product_Review_Trust"),
    ...
    url(r'^View_Prediction_Of_Product_Review_Trust_Ratio/$', serviceprovider.View_Prediction_Of_Product_Review_Trust_Ratio, name="View_Prediction_Of_Product_Review_Trust_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Product_Review_Trust/$', serviceprovider.View_Prediction_Of_Product_Review_Trust, name="View_Prediction_Of_Product_Review_Trust"),
